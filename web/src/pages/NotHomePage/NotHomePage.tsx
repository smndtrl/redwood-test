...
const NotHomePage = () => {
  return (
    <>
      <MetaTags title="NotHome" description="NotHome page" />

      <h1>NotHomePage</h1>
      <p>
        Find me in <code>./web/src/pages/NotHomePage/NotHomePage.tsx</code>
      </p>
      <p>
        My default route is named <code>notHome</code>, link to me with `
        <Link to={routes.notHome()}>NotHome</Link>`
      </p>
...
<Link to={routes.home()} rel="noopener">
        Back
      </Link>
    </>
  )
