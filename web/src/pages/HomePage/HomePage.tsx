...
const HomePage = () => {
  return (
    <>
      ...
      <ol>
        <li>
        <Link to={`${routes.notHome()}#section5`} rel="noopener">
        Link to other page section5
      </Link>
        </li>
        <li>
          <a href="/not-home#section5">A to other page section5</a>
        </li>
      </ol>
      ...
      <a href='#section5' style={{display: "block"}}>Test ahref</a>
      <button style={{display: "block"}} onClick={() => history.pushState({ test: "test" }, undefined, "#section5")}>Test history</button>
      <button style={{display: "block"}} onClick={() => navigate(`#section5`)}>Test navigate</button>
